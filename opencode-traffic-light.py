...
Quit:
    ...
    exits after five seconds without a valid OpenCode status response
"""
import json
import math
import os
...
class Notch(Gtk.Window):
    def __init__(self, preferences_path=None, clock=None):
    ...
    def poll_status(self):
        try:
            ...
            pass  # Keep the last color during brief backend outages.
        if time.monotonic() - self._last_valid_response >= DISCONNECT_GRACE_SECONDS:
            Gtk.main_quit()
            return False
        return True
